  ...
  const bonos: Bono[] = [
    {
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/14AfZj1P37N73VH1ek0RG09'
    },
    {
      id: 'general-10',
      name: 'General Spanish',
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/eVq5kFalz4AV3VHg9e0RG08'
    },
    {
      id: 'general-15',
      name: 'General Spanish',
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/fZueVf1P35EZeAlcX20RG07'
    },
    {
      id: 'general-20',
      name: 'General Spanish',
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/cNi00lbpD5EZfEp8GM0RG06'
    },
    {
      id: 'dele-5',
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/fZu14palzgjD63P3ms0RG04'
    },
    {
      id: 'dele-10',
      name: 'DELE Preparation',
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/fZu8wRctH1oJ1Nz5uA0RG05'
    },
    {
      id: 'dele-15',
      name: 'DELE Preparation',
      ...
      stripeLinkPlaceholder: 'https://buy.stripe.com/6oU3cx65jgjD0Jv4qw0RG03'
    }
  ];
      ...
      <section className="py-20 bg-bg-warm relative" id="precios">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="mb-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch max-w-7xl mx-auto" id="pricing-grid-general">
